...
def run_nlu(model_directory):
	...
	print(interpreter.parse("I am planning my to order an 829 router. How much does it cost?"))

if __name__ == '__main__':
	model_directory = train_nlu('./data/data.json', 'data/config_spacy.yml', './models/nlu')
